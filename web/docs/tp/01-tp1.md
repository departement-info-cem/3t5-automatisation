...
À chacune des questions, répondez en inscrivant la ligne de commande dans le fichier PS1. Chaque question doit être répondue par **une seule ligne de commande**.

:::caution Ligne de commande unique
En PowerShell, le caractère `;` permet de mettre deux lignes de commandes sur la même ligne. Lors que je spécifie **une seule ligne de commande**, je n'accepte pas deux lignes mises bout à bout sur la même ligne avec le point-virgule.

L'exemple ci-dessous est considéré comme **deux lignes de commande**:
<ConsoleWindow backgroundColor="#000046" noCopy="true">
```text
PS C:\> Write-Host "Alpha"; Write-Host "Beta"
Alpha
Beta
```
</ConsoleWindow>
...
----                          ------       ----------        ---------
Ethernet (20Z1)               Disconnected 00-1B-21-F0-39-3C 1 Gbps
Ethernet (20Z2)               Disconnected 00-1B-21-F0-39-D7 1 Gbps
Connexion au réseau local 2   Disconnected                   1 Gbps
Ethernet (CÉGEP)              Up           4C-D7-17-9E-49-B5 1 Gbps
vEthernet (Default Switch)    Up           00-15-5D-E9-2B-2B 10 Gbps
VMware Network Adapter VMnet1 Up           00-50-56-C0-00-01 100 Mbps
VMware Network Adapter VMnet8 Up           00-50-56-C0-00-08 100 Mbps
Connexion au réseau local     Disconnected 00-FF-39-DE-61-0F 1 Gbps
```
</ConsoleWindow>
