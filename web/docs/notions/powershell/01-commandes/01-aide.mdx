...
```text
PS C:\> Get-Help Move-Item

NAME
    Move-Item

SYNTAX
    Move-Item [-Path] <string[]> [[-Destination] <string>] [-Force] [-Filter <string>] [-Include <string[]>] [-Exclude <string[]>] [-PassThru]
    [-Credential <pscredential>] [-WhatIf] [-Confirm] [<CommonParameters>]

    Move-Item [[-Destination] <string>] -LiteralPath <string[]> [-Force] [-Filter <string>] [-Include <string[]>] [-Exclude <string[]>] [-PassThru]
    [-Credential <pscredential>] [-WhatIf] [-Confirm] [<CommonParameters>]
...
REMARKS
    Get-Help cannot find the Help files for this cmdlet on this computer. It is displaying only partial help.
        ...
        -- To view the Help topic for this cmdlet online, type: "Get-Help Move-Item -Online" or
           go to https://go.microsoft.com/fwlink/?LinkID=2096591.
```
</ConsoleWindow>
...
<ConsoleWindow title="PowerShell" backgroundColor="#000046">
```text
PS C:\> Get-EventLog -Newest [CTRL + ESPACE]
Newest               LogName              UserName             InstanceId           OutBuffer            
WarningVariable      Verbose              List                 Message              After                
Source               ErrorAction          OutVariable          InformationVariable  ComputerName         
EntryType            AsString             AsJob                InformationAction    ErrorVariable
Before               AsBaseObject         Index                PipelineVariable     WarningAction        
Debug
```
</ConsoleWindow>
...
Source: [Get-EventLog (Microsoft.PowerShell.Management) - PowerShell | Microsoft Docs](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.management/get-eventlog#syntax)
